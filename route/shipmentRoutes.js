...
const { updateShipment, getShipment, getBOL, createShipment, deleteShipment, getShipmentofBroker, getShipmentofCarrier, getShipmentofCustomer, getShipmentofShipper, dispatchSheet, showBOL } = require("../controller/shipmentController");
...
router.get("/showBol/:id", verifyToken, checkPermission('update-shipment'), showBOL);
