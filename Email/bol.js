...
<body >
	<table  cellspacing="0" cellpadding="0" style="width: 100%;max-width: 856px;margin: auto;font-family: 'Inter', serif;">
		...
		<tr>
			<td>
				<img src="tringle-bg.png" alt="img" />
			</td>
		</tr> 
	</table>
	<table cellspacing="0" cellpadding="0" style="width: 100%;max-width: 856px;margin: auto;font-family: 'Inter', serif;">
			...
			<td valign="top" width="35%" style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 20px 10px 20px 20px;">
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					 <tr>
					 	...
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">2/9/2029</td>
					 </tr>
					  <tr>
					  ...
					  <tr>
					 	...
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">consumer goods or appliances</td>
					 </tr>
				</table> 
			</td>			
			<td valign="top" width="35%" style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 20px 10px 20px 10px;;">
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					 <tr>
					 	...
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">Smartway</td>
					 </tr>
					  <tr>
					 	<td style="padding-bottom: 10px;">Carrier # :</td>
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">tarnsport</td>
					 </tr>
					  <tr>
					 	<td style="padding-bottom: 10px;">Dirver :</td>
				...
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					 <tr>
					  ...
					  <tr>
					 	...
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">45</td>
					 </tr>
					  <tr>
					 	<td style="padding-bottom: 10px;">Pieces :</td>
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">$s</td>
					 </tr>
				</table> 
			</td>			
			<td valign="top" width="35%" style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 20px 10px 20px 10px;;">
				<table cellspacing="0" cellpadding="0" style="width: 100%;">
					 <tr>
					 	<td style="padding-bottom: 10px;">Driver cell:</td>
					 	<td style="color: #7A7A7A;padding-bottom: 10px;"></td>
					 </tr>
					  <tr>
					 	<td style="padding-bottom: 10px;">Contact: </td>
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">navjet</td>
					 </tr>
					  <tr>
					 	<td style="padding-bottom: 10px;">phone:</td>
					 	<td style="color: #7A7A7A;padding-bottom: 10px;">+1234567890</td>
					 </tr>
				</table> 
			</td> 
			<td valign="top" width="30%" style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 20px 20px 20px 10px;	;">
				...
				<table cellspacing="0" cellpadding="0" style="width: 100%;border: 1px solid #a5a5a5">
					   ...
					   <td valign="top" width="75%" >
					   	   <table cellspacing="0" cellpadding="0" style="width: 100%;" >
					   	   	  <tr>
					   	   	  	...
					   	   	  	<td width="75%" style="color: #1B1B1B;font-size: 14px;padding: 10px 10px 5px 10px;">21/12/2024 07:00</td>
					   	   	  </tr>
					   	   	  <tr>
					   	   	  	<td style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 5px 10px 7px 10px;border-right: 1px solid #a5a5a5;border-bottom: 1px solid #a5a5a5;">name/ Address:</td>
					   	   	  	<td style="color: #1B1B1B;font-size: 14px;padding: 5px 10px 7px 10px;">244-hh-priority  One - Fairfiel 2345 huntington </td>
					   	   	  </tr>
					   	   </table>
					   </td>	
					...
					<tr>
					   <td valign="top" width="75%" >
					   	   <table cellspacing="0" cellpadding="0" style="width: 100%;" >
					   	   	  <tr>
					   	   	  	<td width="25%" style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 7px 10px 5px 10px; ">Directions :</td>
					   	   	  	<td width="75%" style="color: #1B1B1B;font-size: 14px;padding: 10px 10px 5px 10px;">Monticello, in 47960</td>
					   	   	  </tr>
					   	   	  <tr>
					   	   	  	<td style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 5px 10px 7px 10px;">specific instructions :</td>
					   	   	  	<td style="color: #1B1B1B;font-size: 14px;padding: 5px 10px 7px 10px;">Pickup # : 4564748 </td>
					   	   	  </tr>
					   	   </table>
					   </td>	
					   <td valign="top"  width="25%">
					...
					<tr>
					   <td valign="top" width="75%" >
					   	   <table cellspacing="0" cellpadding="0" style="width: 100%;" >
					   	   	  <tr>
					   	   	  	<td width="25%" style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 7px 10px 5px 10px; ">Directions :</td>
					   	   	  	<td width="75%" style="color: #1B1B1B;font-size: 14px;padding: 10px 10px 5px 10px;">Fairfield, ca 94553</td>
					   	   	  </tr>
					   	   	  <tr>
					   	   	  	<td style="color: #1B1B1B;font-weight: bold;text-transform: uppercase;font-size: 14px;padding: 5px 10px 7px 10px;">specific instructions :</td>
					   	   	  	<td style="color: #1B1B1B;font-size: 14px;padding: 5px 10px 7px 10px;">Pickup # : 4564748 </td>
				...
				<table cellspacing="0" cellpadding="0" style="width: 100%;border: 1px solid #a5a5a5">  
					   ...
					   <td valign="bottom" width="50%">
					   	   <table cellspacing="0" cellpadding="0" style="width: 100%;">
					   	   	  ...
					   	   	  <tr>
					   	   	  	<td style="color: #1B1B1B;font-weight: bold; font-size: 20px;padding: 5px 10px 7px 0px;text-align: right; ">Total Carrier Pay : $3000.00 </td> 
					   	   	  </tr>
					   	   </tbody>
					   	</table>
					   </td>			
